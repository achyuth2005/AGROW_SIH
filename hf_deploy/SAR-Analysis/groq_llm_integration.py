"""
============================================================================
FILE: groq_llm_integration.py
============================================================================
PURPOSE: Integrates Groq LLM (Llama 3.3 70B) for intelligent crop health
         analysis. Takes raw SAR statistics and weather data, then uses the
         Groq API to generate human-readable insights and recommendations.
...
API KEY ROTATION:
    The file maintains a pool of Groq API keys with automatic fallback.
...
def call_groq_llm_structured(
    ...
    """
    Call the Groq LLM (Llama 3.3 70B) with agricultural context and get structured output.
...
def prepare_llm_input(features, stressed_indices, patches, df_weather, CROP_TYPE, 
    ...
    4. Calls the Groq LLM with all this context
...
"""
    ...
    result = call_groq_llm_structured(
        crop_type=CROP_TYPE,
