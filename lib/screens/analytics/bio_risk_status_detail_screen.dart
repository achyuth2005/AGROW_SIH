/// ===========================================================================
/// BIO-RISK STATUS DETAIL SCREEN
/// ===========================================================================
///
/// PURPOSE: Detailed analytics dashboard for biological risk assessment.
///          Displays 4 risk indicators with CNN+LLM-powered heatmaps.
///
/// KEY SECTIONS:
///   1. Pest Risk - Probability of pest infestation
///   2. Disease Risk - Likelihood of crop diseases
///   3. Nutrient Stress - Nutrient deficiency indicators
///   4. Stress Zones - Spatial stress pattern detection
///
/// VISUALIZATION:
///   - HeatmapDetailCard: LLM-mode heatmaps (not pixel-wise)
///   - Stress zone map with directional indicators
///   - Color-coded risk levels (high/moderate/low)
///
/// DATA FLOW:
///   1. Receives s2Data from navigation (contains center_lat, center_lon)
///   2. Passes coordinates to HeatmapDetailCard with LLM metrics
///   3. HeatmapService runs CNN+Clustering+LLM analysis
///   4. Returns risk levels, analysis text, recommendations
///
/// LLM METRICS (require neural network + LLM):
///   - pest_risk, disease_risk, nutrient_stress, stress_zones
///   - Unlike pixel-wise metrics, these use deep learning inference
///
/// DEPENDENCIES:
