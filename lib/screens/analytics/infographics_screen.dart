...
/// ===========================================================================
///
/// PURPOSE: Visual dashboard of farm performance metrics.
///          Displays circular progress charts for key indicators.
///
/// METRICS DISPLAYED:
///   - Crop Yield (75%)
///   - Water Usage (60%)
...
///
/// UI FEATURES:
///   - Responsive grid (2 cols mobile, 4 cols web)
///   - Circular progress indicators with percentages
///   - Dark gradient background with glassmorphism cards
///
/// NOTE: Currently uses dummy data. Integration with actual
///       farm analytics pending backend development.
/// ===========================================================================
