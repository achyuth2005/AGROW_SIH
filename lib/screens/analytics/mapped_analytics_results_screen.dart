...
/// ===========================================================================
///
/// PURPOSE: Display heatmap overlays on Google Maps for selected metrics.
///          Provides LLM-powered analysis and recommendations.
///
/// KEY FEATURES:
///   - PageView for swiping between selected categories
///   - Google Maps with field polygon overlay
///   - Heatmap image overlay with opacity blending
///   - Cached heatmaps with force-refresh option
///   - LLM analysis text with recommendations
///
/// HEATMAP LOADING:
///   1. Check HeatmapCacheService for cached data
///   2. If cached → display immediately
///   3. If not → fetch from HeatmapService API
///   4. Parallel fetch of time series data for LLM context
///   5. Cache result for future use
///
/// UI COMPONENTS:
///   - Map with field polygon boundary
///   - Heatmap overlay (55% opacity)
///   - Optional colorbar below map
///   - Analysis text box with recommendations
///   - Page dots for category navigation
///
/// DEPENDENCIES:
///   - HeatmapService: Fetch heatmap images + analysis
///   - HeatmapCacheService: Local caching
///   - TimeSeriesService: Context data for LLM
