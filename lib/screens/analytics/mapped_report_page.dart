...
/// ===========================================================================
///
/// PURPOSE: Display field analytics with map overlay and swipeable metric cards.
///          Shows 5 metrics: Crop Health, Soil, Weather, Yield, Risk.
///
/// KEY FEATURES:
///   - Google Maps with field polygon and markers
///   - Expand view option for fullscreen map
///   - PageView with 5 metric cards (swipeable)
///   - Extended Analytics bottom sheet with detailed data
///   - Page indicator dots
///
/// METRICS DISPLAYED:
///   1. Crop Health (NDVI, stress, growth stage)
///   2. Soil Condition (pH, moisture, nutrients)
///   3. Weather Impact (temp, humidity, rainfall)
///   4. Yield Prediction (projected yield, revenue)
///   5. Risk Assessment (pest, disease, market)
///
/// NOTE: Currently uses simulated data - AI model integration pending.
///
/// HELPER WIDGETS:
///   - _ExpandedMapView: Fullscreen map display
///   - _ExtendedAnalyticsSheet: Detailed metrics bottom sheet
///
/// DEPENDENCIES:
