/// ===========================================================================
/// SOIL STATUS DETAIL SCREEN
/// ===========================================================================
///
/// PURPOSE: Detailed analytics dashboard for soil health metrics.
///          Displays 4 key soil indicators with heatmaps and time series.
///
/// KEY SECTIONS:
///   1. Soil Moisture (SMI) - Water content in soil
///   2. Soil Organic Matter (SOMI) - Organic carbon levels
///   3. Soil Fertility (SFI) - Overall nutrient availability
///   4. Soil Salinity (SASI) - Salt concentration levels
///
/// VISUALIZATION:
...
///   3. HeatmapService fetches pixel-wise soil indices
///   4. TimeSeriesService provides historical trends
///
/// DEPENDENCIES:
