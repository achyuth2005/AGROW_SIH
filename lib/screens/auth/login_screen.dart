...
/// ============================================================================
/// PURPOSE: User authentication screen supporting multiple sign-in methods.
/// 
/// SIGN-IN OPTIONS:
...
///   - Conditional OTP dialog for phone auth
///   - Guest user session with local field filtering
/// 
/// POST-AUTH FLOW:
///   - Syncs user profile to Supabase user_profiles table
///   - Saves display name and avatar URL to SharedPreferences
///   - Navigates to /location-permission screen
/// 
/// DEPENDENCIES:
