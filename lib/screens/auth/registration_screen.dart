...
/// ===========================================================================
///
/// PURPOSE: New user account creation with email/password authentication.
///          Creates Firebase Auth account and syncs to Supabase profile.
///
/// REGISTRATION FLOW:
///   1. User enters email/phone, password, confirm password
///   2. Validates: non-empty fields, password match, min 6 chars
///   3. Creates Firebase Auth user via createUserWithEmailAndPassword()
///   4. Syncs to Supabase user_profiles table with user_id
...
///
/// ERROR HANDLING:
///   - Firebase Auth exceptions (e.g., email already in use)
///   - Database errors (Supabase connection)
///   - Generic error catching with user feedback
///
/// UI DESIGN:
///   - Dark green form container on light background
///   - Password visibility toggle
///   - "Already have account?" link to login
///
/// DEPENDENCIES:
///   - firebase_auth: Account creation
///   - cloud_firestore: Legacy (can be removed)
///   - supabase_flutter: Profile sync
/// ===========================================================================
