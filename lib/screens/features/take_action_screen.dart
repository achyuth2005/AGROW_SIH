/// ============================================================================
/// FILE: take_action_screen.dart
/// ============================================================================
/// PURPOSE: Shows actionable recommendations for selected field with category
///          cards linking to detailed AI analysis screens.
/// 
/// KEY FEATURES:
///   - Field selector with Google Maps satellite preview
///   - 6 action category cards with progress indicators
///   - Routes to FieldVariabilityScreen or IrrigationSchedulingScreen
///   - Passes field polygon and farmer profile to detail screens
/// 
/// ACTION CATEGORIES:
///   1. Field Variability - Spatial analysis
///   2. Yield Stability - Production trending
///   3. Irrigation Scheduling - Water management
///   4. Vegetation Health - Crop status
///   5. Nutrient Deficiency - Soil nutrition
///   6. Pest Damage - Infestation risk
/// 
/// DEPENDENCIES:
///   - google_maps_flutter: Field preview
///   - TakeActionService: AI recommendations
///   - FieldVariabilityScreen / IrrigationSchedulingScreen: Detail views
/// ============================================================================
...
import 'package:agroww_sih/screens/analytics/field_variability_screen.dart';
import 'package:agroww_sih/screens/features/irrigation_scheduling_screen.dart';
