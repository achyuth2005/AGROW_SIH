/// ============================================================================
/// FILE: farmland_map_screen.dart
/// ============================================================================
/// PURPOSE: Interactive map for viewing, searching, and adding farmland fields.
///          Displays all user fields with custom text markers.
/// 
/// KEY FEATURES:
///   - Google Maps satellite view with field polygons
///   - Tap to add 4-corner field boundary (add mode)
///   - Custom text markers showing field name and crop type (scaled by area)
///   - Field search and notes access
///   - Field details bottom sheet with edit/delete actions
///   - Undo last point while drawing
/// 
/// ADD FIELD FLOW:
///   1. Tap "Add New Field" button
///   2. Tap 4 corners on map to define polygon
///   3. Tap "Finish" to open details sheet
///   4. Enter field name and crop type
///   5. Save to Supabase coordinates_quad table
/// 
/// MAP OBJECTS:
///   - _polygons: Set of field and drawing polygons
///   - _markers: Custom text markers for labels and corner pins
/// 
/// DEPENDENCIES:
///   - google_maps_flutter: Map rendering and interaction
///   - Supabase: Field storage (coordinates_quad table)
/// ============================================================================
...
import '../features/add_note_screen.dart';
