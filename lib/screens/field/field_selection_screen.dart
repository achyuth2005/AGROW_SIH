...
/// ===========================================================================
///
/// PURPOSE: Select saved farmland for Sentinel-2 or SAR analysis.
///          Provides list of user's saved fields from Supabase.
///
/// KEY FEATURES:
///   - Fetches fields from coordinates_quad table
///   - Shows field name, crop type, and size
///   - Empty state with manual entry option
///   - Returns selected field via Navigator.pop()
///
/// USAGE:
///   - Called before Sentinel2AnalysisScreen or SARAnalysisScreen
///   - Returns null if user chooses manual entry
///   - Returns field Map if user selects a saved field
///
/// DEPENDENCIES:
