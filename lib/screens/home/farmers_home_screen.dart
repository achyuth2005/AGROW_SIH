/// ============================================================================
/// FILE: farmers_home_screen.dart
/// ============================================================================
/// PURPOSE: Simplified dashboard for farmers. Displays easy-to-understand
///          status cards with color-coded indicators and plain language labels.
/// 
/// KEY FEATURES:
///   - Simplified 4-card carousel: Soil, Crop, Weather, Bio Risk
///   - Color-coded status indicators (green/yellow/red)
///   - Simplified labels (Good/Moderate/Attention Needed)
///   - Quick action buttons for common tasks
///   - Weather data integration from SAR service
///   - Take Action integration for AI recommendations
/// 
/// DIFFERENCES FROM home_screen.dart:
///   - Uses FarmersBottomNavBar (4 items instead of 5)
///   - Simplified status display with less technical jargon
///   - Focus on actionable insights over raw data
///   - Integrated nutrient analysis via TakeActionService
/// 
/// DATA SOURCES:
///   - Sentinel2Service: Vegetation and soil indices
///   - SarAnalysisService: Weather data
///   - TakeActionService: AI recommendations
/// 
/// DEPENDENCIES: firebase_auth, supabase_flutter, shared_preferences, intl
/// ============================================================================
...
import '../misc/news_screen.dart';
import '../features/view_notes_screen.dart';
...
import 'package:agroww_sih/screens/misc/knowledge_hub_screen.dart';
