...
/// ============================================================================
/// PURPOSE: Main dashboard for agronomist/power users. Displays farm health
///          overview with carousel cards for Soil, Weather, Crop, and Bio Risk.
/// 
/// KEY FEATURES:
///   - Field selection with auto-redirect to Add Farmland if none exist
///   - Cache-first data loading (instant display from cache while checking API)
///   - 4-card carousel: Soil Status, Weather, Crop Status, Bio Risk
///   - SAR analysis integration for weather data
///   - Sentinel-2 analysis for vegetation indices
///   - Action grid for quick access to app features
/// 
/// DATA FLOW:
///   1. Check farmlands from Supabase
///   2. Load cached data immediately (if available)
///   3. Fetch fresh SAR analysis → updates weather, health summary
///   4. Fetch Sentinel-2 analysis → updates LLM insights
///   5. Save to cache for next visit
/// 
/// STATE MANAGEMENT:
///   - _isLoadingSar: SAR analysis in progress
///   - _isLoadingS2: Sentinel-2 analysis in progress
///   - _selectedField: Currently selected farmland
///   - _cacheLastUpdated: Timestamp for cache status display
/// 
/// DEPENDENCIES:
///   - SarAnalysisService: SAR data and weather
///   - Sentinel2Service: Vegetation indices and AI analysis
///   - CacheService: Local caching for instant display
///   - Supabase: Field data storage
...
import 'package:agroww_sih/screens/field/locate_farmland_screen.dart';
import 'package:agroww_sih/screens/misc/coming_soon_screen.dart';
import 'package:agroww_sih/screens/field/full_screen_map_page.dart';
...
import 'package:agroww_sih/screens/settings/settings_screen.dart';
import 'package:agroww_sih/screens/analytics/infographics_screen.dart';
...
import 'package:agroww_sih/screens/features/view_notes_screen.dart';
