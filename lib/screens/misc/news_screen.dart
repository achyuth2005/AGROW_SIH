...
/// ===========================================================================
///
/// PURPOSE: Agricultural newsletter feed with categorized articles.
...
///
/// KEY FEATURES:
///   - Category chip filters (horizontal scroll)
///   - Search/Sort/Saved/Liked filter bar
///   - Image and text-only card layouts
///   - Interested/Uninterested action buttons
///   - Load More pagination button
///
/// NOTE: Currently uses mock data. Integration with actual
///       news API pending backend development.
/// ===========================================================================
