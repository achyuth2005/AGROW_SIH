...
/// ===========================================================================
///
/// PURPOSE: Display push notifications received by the user.
///          Notifications are persisted and loaded from SharedPreferences.
///
/// KEY FEATURES:
///   - List of notification cards with title, body, date/time
///   - Persistent storage using SharedPreferences
///   - Search bar (placeholder for future implementation)
///   - Empty state handling
///
/// DATA PERSISTENCE:
///   - Loads from 'notifications' key in SharedPreferences
///   - Notifications stored as JSON-encoded list
///
/// DEPENDENCIES:
///   - shared_preferences: Notification storage
