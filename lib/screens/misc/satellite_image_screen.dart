...
/// ===========================================================================
///
/// PURPOSE: Display Sentinel-2 satellite imagery with polygon overlay.
///          Entry point to mapped report analytics.
///
/// KEY FEATURES:
///   - Fetches satellite image from local or HuggingFace backend
///   - Dynamic loading messages during fetch
///   - Polygon overlay on satellite imagery
///   - Metadata display (date, cloud cover)
///   - Fallback to HuggingFace Space if local server fails
///
/// API FLOW:
///   1. Convert polygon points to [lon, lat] format
///   2. POST to /api/satellite endpoint
///   3. Decode base64 image and display
///   4. Draw polygon overlay using PolygonPainter
///
/// NAVIGATION:
///   - Proceed to Analytics → MappedReportAnalysisScreen
///
/// DEPENDENCIES:
///   - http: API calls
