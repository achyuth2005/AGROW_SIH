...
/// ===========================================================================
///
/// PURPOSE: Request push notification permission during onboarding.
///          Part of the onboarding flow after location permission.
///
/// PERMISSION FLOW:
///   1. Display explanation of why notifications are needed
///   2. "Allow" → Request permission via permission_handler
///   3. If granted → /intro (main onboarding)
