...
/// ===========================================================================
///
/// PURPOSE: Configure infographics download options.
///          Allows bulk or selective download of analytics graphs.
///
/// KEY FEATURES:
///   - Download All Graphs option
///   - Select specific graphs to download
///   - Format selection (PNG, PDF, etc.)
///   - Navigation back to Infographics or Menu
///
/// UI DESIGN:
///   - Green gradient background
///   - Card-based layout with large tap targets
///   - Home chip at bottom for quick navigation
///
/// NOTE: Some features are visual placeholders pending backend integration.
/// ===========================================================================
