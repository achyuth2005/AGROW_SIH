...
/// ===========================================================================
///
/// PURPOSE: Allow users to change the app's display language.
///          Supports English, Hindi, and Bengali.
///
/// KEY FEATURES:
///   - Search/filter languages by name
///   - Preview native language names
///   - Instant language switch via LocalizationProvider
///   - Checkmark indicator for current selection
///
/// SUPPORTED LANGUAGES (AppLanguage enum):
///   - english (English)
///   - hindi (हिंदी)
///   - bengali (বাংলা)
///
/// DATA PERSISTENCE:
///   - Language preference saved via LocalizationProvider
///   - Persisted in SharedPreferences
///
/// DEPENDENCIES:
///   - LocalizationProvider: Language state management
