...
/// ===========================================================================
///
/// PURPOSE: User profile management screen for viewing and editing
///          personal information, avatar, and account details.
///
/// KEY FEATURES:
///   - Avatar upload (camera or gallery) to Supabase Storage
///   - Editable fields: name, phone, email, DOB, address
///   - Date picker for DOB field
///   - Email validation before save
///   - Auto-sync with Supabase user_profiles table
///
/// PROFILE FIELDS (JSON-driven):
...
///
/// AVATAR UPLOAD FLOW:
///   1. Tap camera icon → choose gallery/camera
///   2. ImagePicker captures photo
///   3. Upload to Supabase Storage (profile_avatars bucket)
///   4. Get public URL and save to profile
///   5. Cache URL in SharedPreferences for global access
///
/// DATA PERSISTENCE:
///   - Firebase Auth: Authentication only
///   - Supabase: user_profiles table for all profile data
///   - SharedPreferences: user_full_name, user_avatar_url
///
/// DEPENDENCIES:
///   - firebase_auth, supabase_flutter
