...
///          Central navigation to all app configuration options.
///
/// KEY FEATURES:
///   - User profile card with avatar, name, role
///   - Edit Profile / Change Password options
///   - Navigation to Legacy Main Menu, All Features, Language
///   - Logout functionality (Firebase + Google Sign Out)
///
/// SETTINGS OPTIONS:
///   - Legacy Main Menu → MainMenuScreen
///   - All Features → /main-menu-list
///   - Language → /language-selection (multi-language support)
///   - Coordinates History (coming soon)
...
///
/// DATA SOURCES:
///   - SharedPreferences: user_full_name
///   - UserRoleProvider: isFarmer flag
///
/// DEPENDENCIES:
///   - firebase_auth, google_sign_in: Logout
///   - shared_preferences: User data
///   - UserRoleProvider: Role display
/// ===========================================================================
