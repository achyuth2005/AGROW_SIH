...
/// ===========================================================================
///
/// PURPOSE: Navigation drawer with settings and utility links.
///          Accessible from home screens via hamburger menu.
///
/// MENU ITEMS:
///   - Profile, Export Reports, Language Preference
///   - Permissions, Privacy & Security, Feedback
///   - Help & Support, App Tutorial, FAQs
///   - Mapped Analytics, Legacy Main Menu
///   - Log out (with Google Sign Out)
///
/// KEY FEATURES:
///   - Localized menu item titles
///   - Rounded pill-style menu buttons
///   - Firebase + Google Sign Out on logout
///
/// DEPENDENCIES:
///   - firebase_auth: Logout
///   - google_sign_in: Google Sign Out
///   - LocalizationProvider: i18n menu titles
/// ===========================================================================
...
import '../analytics/mapped_analytics_home_screen.dart';
