...
/// Localization provider for managing app language
...
class AppTranslations {
  static final Map<String, Map<String, String>> _translations = {
    ...
    // Irrigation Screen
    'crop_moisture_content': {'en': 'Crop Moisture Content', 'hi': 'फसल की नमी सामग्री', 'bn': 'ফসলের আর্দ্রতা বিষয়বস্তু'},
    'how_to_make_better': {'en': 'How to make it better', 'hi': 'इसे बेहतर कैसे बनाएं', 'bn': 'কীভাবে এটি আরও ভাল করা যায়'},
    'moisture_level': {'en': 'Moisture Level', 'hi': 'नमी का स्तर', 'bn': 'আর্দ্রতা স্তর'},
    'detailed_pathway': {'en': 'Detailed Pathway', 'hi': 'विस्तृत मार्ग', 'bn': 'বিস্তারিত পথ'},
    'crop_stage_statistics': {'en': 'Crop Stage Statistics', 'hi': 'फसल चरण सांख्यिकी', 'bn': 'ফসলের পর্যায় পরিসংখ্যান'},
    'what_stage_crop_is': {'en': 'What stage the crop is', 'hi': 'फसल किस चरण में है', 'bn': 'ফসল কোন পর্যায়ে আছে'},
    'detailed_report': {'en': 'Detailed Report', 'hi': 'विस्तृत रिपोर्ट', 'bn': 'বিস্তারিত প্রতিবেদন'},
    ...
    'irrigation_priority_zones': {'en': 'Irrigation Priority Zones', 'hi': 'सिंचाई प्राथमिकता क्षेत्र', 'bn': 'সেচ অগ্রাধিকার অঞ্চল'},
    'high_priority': {'en': 'High Priority', 'hi': 'उच्च प्राथमिकता', 'bn': 'উচ্চ অগ্রাধিকার'},
    'mid_priority': {'en': 'Mid Priority', 'hi': 'मध्यम प्राथमिकता', 'bn': 'মাঝারি অগ্রাধিকার'},
    'low_priority': {'en': 'Low Priority', 'hi': 'कम प्राथमिकता', 'bn': 'নিম্ন অগ্রাধিকার'},
    'zones': {'en': 'zones', 'hi': 'क्षेत्र', 'bn': 'অঞ্চল'},
    'classification_reason': {'en': 'Major Reason behind Classification', 'hi': 'वर्गीकरण के पीछे प्रमुख कारण', 'bn': 'শ্রেণিবিন্যাসের পিছনে প্রধান কারণ'},
    'how_to_act': {'en': 'How to act upon Priority Areas', 'hi': 'प्राथमिकता वाले क्षेत्रों पर कैसे कार्य करें', 'bn': 'অগ্রাধিকার ক্ষেত্রগুলিতে কীভাবে কাজ করবেন'},
    'ask_chatbot': {'en': 'Ask Chatbot', 'hi': 'चैटबॉट से पूछें', 'bn': 'চ্যাটবটকে জিজ্ঞাসা করুন'},
